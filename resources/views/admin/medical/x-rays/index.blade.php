...
@section('content')
                    <a class="btn btn-success" href="javascript:void(0)" id="createNewX-ray"> {{__('messages.Create New X-ray')}}</a>
...
<script type="text/javascript">
    $(function () {
        $('#page-tage').html('{{__("messages.X-rays")}}');
      ...
      --------------------------------------------
      --------------------------------------------*/
      $('#createNewX-ray').click(function () {
          $('#saveBtn').val("create-xray");
          $('#x-ray_id').val('');
          $('#adminForm').trigger("reset");
          $('#modelHeading').html('{{__("messages.Create New X-ray")}}');
      ...
      --------------------------------------------
      --------------------------------------------*/
      $('body').on('click', '.editXray', function () {
        var xray_id = $(this).data('id');
        $.get("{{ route('xrays.index') }}" +'/' + xray_id +'/edit', function (data) {
            $('#modelHeading').html("{{ __('messages.Edit') }}");
            $('#saveBtn').val("edit-xray");
            $('#ajaxModel').modal('show');
            $('#xray_id').val(data.id);
      ...
      --------------------------------------------
      --------------------------------------------*/
      $('body').on('click', '.deleteXray', function () {
