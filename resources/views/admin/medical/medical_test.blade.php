                ...
                <div class="container text-center">
                    ...
                    <div class="container">
                        <div class="header-line">
                            ...
                            <div class="row mt-2 head justify-content-center">

                                <div class="col" style="text-align: left;">
                                    <p>Temp: {{ $reservation->temperature }} C </p>
                                </div>
                            </div>
                            <div class="row mt-2 medical">
                                <div class="col" style="text-align: left;padding-right: 50px;font-size: 15px;">
                                    <p>Diagonoses :
                    ...
                    @if(count($reservation->medicalTests) >0)
                    <div>
                        <h3>التحاليل المطلوبة</h3>
                    </div>
                    <div>
                        @foreach ($reservation->medicalTests as $key => $medicalTest)
                            <div class="row medical">
                                <div class="col">
                                    <p>{{ $medicalTest->name }}<img src="{{ asset('assets/images/icons/r.png') }}">
                                    </p>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div>
                        <div class="row">
                            <div class="col" style="border-top:#4ec0e7 solid 2px; ">
                                ...
                                <p class="footer-sheet"><img src="{{ asset('assets/images/icons/icon1.png') }}"> Clinc
                                    : {{ $clinc->value }}</p>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="footer-sheet"><img src="{{ asset('assets/images/icons/icon2.png') }}"> Tel. :
                                    {{ $tel->value }}</p>
                                <p class="footer-sheet"><img src="{{ asset('assets/images/icons/icon4.png') }}"> Mob. :
                                    {{ $mobile->value }}</p>
                            ...
                            <div class="col">
                                ...
                                <p style="font-size: 14px;" class="footer-sheet"><img
                                        src="{{ asset('assets/images/icons/icon3.png') }}"> Hospital :
                                    {{ $hospital->value }}</p>
                                <p style="font-size: 14px;" class="footer-sheet"><img
                                        src="{{ asset('assets/images/icons/icon5.png') }}"> Email :
                                    {{ $email->value }}</p>
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="footer-sheet">الاستشارة خلال اسبوع من تاريخ الكشف - نرجو احضار الروشتة في
                                    الاستشارة</p>
