...
?>
                ...
                <div id="showFollowUp{{$reservation->id}}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="text-center mt-3 mb-3">
                                    <button class="btn btn-success">{{__('messages.Medication prescription printing')}}</button>
                                    <button class="btn btn-success">{{__('messages.Printing medical Test')}}</button>
                                </div>
