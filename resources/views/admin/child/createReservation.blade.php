<form id="adminForm" name="adminForm" >
    ...
    <input type="hidden" name="is_follow_up" id="is_follow_up" value="0">
        ...
        <h5 class="mb-4 text-uppercase"><i class="fe-calendar"></i> {{__('messages.Add Reservation')}}</h5>
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mt-3">
                    ...
                    <div class="mt-3" id="showSlot" style="display: none">
                        <select class="form-select" name="slot_id" id="slot_id">
                            ...
                            <option value="{{ $slot->id }}"> {{\Carbon\Carbon::createFromFormat('Y-m-d',$slot->date)->dayName}} -{{$slot->date}} - {{date('h:i a', strtotime($slot->from))}}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="row mt-4" id="showDatetime" style="display: none">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                {{-- <input type="date" class="form-control" id="date" name="date" min= {{ now()->toDateString('Y-m-d h:i a') }}> --}}
                                <input type="datetime-local" class="form-control" id="date" name="date"  min="{{ now()->format('Y-m-d h:i a')}}">
                            </div>
                        </div>
