...
@section('content')
    <a class="btn btn-success" href="javascript:void(0)" id="createNewBlog"> {{__('messages.Create New blog')}}</a>
    ...
    <div id="ajaxModel" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <form id="adminForm" name="adminForm" enctype="multipart/form-data" class="form-horizontal">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#createNewBlog').click(function () {
                ...
                $('#modelHeading').html('{{__("messages.Create New blog")}}');
