...
$reservedSlots = \App\Models\Slot::whereIn('id',array_unique(\App\Models\Reservation::whereIn('slot_id',$slotsForDay)->get()->pluck('slot_id')->toArray()))->get();

$reservations = \App\Models\Reservation::where('type','=',$type)->whereDate('special_datetime',$date)->get();
@endphp
