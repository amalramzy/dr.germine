...
@section('content')
                    <a class="btn btn-success" href="javascript:void(0)" id="createNewExpense"> {{__('messages.Create New Expenses')}}</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="adminForm" name="adminForm" class="form-horizontal" enctype="multipart/form-data">
                ...
                <input type="hidden" name="type" class="form-check-input" id="type" value="expenses">
...
<script type="text/javascript">
    $(function () {
        $('#page-tage').html('{{__("messages.Expenses")}}');
      /*------------------------------------------
       --------------------------------------------
       Pass Header Token
       --------------------------------------------
      ...
      $('#createNewExpense').click(function () {
          ...
          $('#modelHeading').html('{{__("messages.Create New Expenses")}}');
