                           ...
                           <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">{{__('messages.Create New Doctor')}}</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="file" name="document[]" id="document"  class="form-control form-control-alternative @error('document') is-invalid @enderror" placeholder="{{ __('Documents') }}" multiple>
                            </div>
                        </div>
