...
@section('content')
                    ...
                    <div>
                        <a class="btn btn-icon btn-success btn-create" href="{{route('doctors.create')}}">
                            <span class="btn-inner--icon"><i class="ni ni-bag-17"></i></span>
                            <span class="btn-inner--text">{{__('messages.Create New Doctor')}}</span>
                        </a>
                    </div>
...
<script type="text/javascript">
    $(function () {
        $('#page-tage').html('{{__("messages.Doctors")}}');
    ...
    //       $('#saveBtn').val("create-doctor");
    //       $('#doctor_id').val('');
    //       $('#adminForm').trigger("reset");
    //       $('#modelHeading').html('{{__("messages.Create New Doctor")}}');
    ...
    //     $.get("{{ route('doctors.index') }}" +'/' + doctor_id +'/edit', function (data) {
    //         $('#modelHeading').html("{{ __('messages.Edit') }}");
    //         $('#saveBtn').val("edit-doctor");
    //         $('#ajaxModel').modal('show');
    ...
    //   --------------------------------------------*/
      $('body').on('click', '.deleteDoctor', function () {
          ...
          if(confirm("{{__('messages.Are You sure want to delete !')}}")){
            ...
            $.ajax({
              type: "DELETE",
              url: "{{ route('doctors.store') }}"+'/'+doctor_id,
              success: function (data) {
                  table.draw();
              },
              error: function (data) {
