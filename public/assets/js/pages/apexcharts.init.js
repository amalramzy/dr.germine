...
options = {
    chart: {
        height: 380, type: "area", stacked: !0, events: {
...
function generateDayWiseTimeSeries(e, o, t) {
    for (var a = 0, r = []; a < o;) {
        var s = e, i = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min;
...
function generateData(e, o, t) {
    for (var a = 0, r = []; a < o;) {
        var s = Math.floor(750 * Math.random()) + 1, i = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min,
...
function generateData1(e, o, t) {
    for (var a = 0, r = []; a < o;) {
        var s = Math.floor(Math.random() * (t.max - t.min + 1)) + t.min, i = Math.floor(61 * Math.random()) + 15;
